...
class OmsUser extends AbstractModel
{
    #数据表名称
    protected $tableName = 'bs_oms_user';

    protected $primaryKey = 'oms_user_id';
     ...
     * @method:单条查询
     * @param array $where 查询条件
     * @return OmsUser|array|bool|AbstractModel|\EasySwoole\ORM\Db\Cursor|\EasySwoole\ORM\Db\CursorInterface|null
